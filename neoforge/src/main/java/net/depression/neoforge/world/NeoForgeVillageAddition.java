package net.depression.neoforge.world;
...
public class NeoForgeVillageAddition {
    public static final DeferredRegister<PoiType> POI_TYPES = DeferredRegister.create(Depression.MOD_ID, Registries.POINT_OF_INTEREST_TYPE);
