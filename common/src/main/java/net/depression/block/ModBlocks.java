...
public class ModBlocks {
    ...
    public static final RegistrySupplier<Block> COMPUTER = registerBlock("computer",
            () -> new ComputerBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).forceSolidOn().noOcclusion()));
